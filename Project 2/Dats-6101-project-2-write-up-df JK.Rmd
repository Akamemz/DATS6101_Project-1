...
Next, we will analyze the correlation between the presence of an abstinence education in school curricula for each state and their respective pregnancy rates.
