...
Analysis of demographic characteristics: examination of how pregnancy, birth, and abortion rates vary by age, race/ethnicity, marital status, and education level.
...
The table here represents an overview of all variables for teens 15 to 19 years old. As you might have noticed we have pregnancyrate over 100%. Our team used data which was already cleaned, and this high birth rate is because the paper that we used have crested their own estimates to supplement the missing data.
...
```
Our data set has this result for regression tree after running it for the whole data set. Results have shown that birthrate1519 and abortionrate1519 were determining factors on pregnancy rate. We did not preform any type of control or pruning as we had small amount of observations
...
# Reference
1. Research paper - https://www.guttmacher.org/report/pregnancies-births-abortions-in-united-states-1973-2017

2. Methodology of paper - https://www.guttmacher.org/sites/default/files/report_downloads/pregnancies-births-abortions-us-1973-2017-method-appendix.pdf

3. Data - https://osf.io/kthnf/

4. Substance - https://www.guttmacher.org/state-policy/explore/substance-use-during-pregnancy

5. Abortion policy - https://www.guttmacher.org/state-policy/explore/abortion-bans-cases-sex-or-race-selection-or-genetic-anomaly